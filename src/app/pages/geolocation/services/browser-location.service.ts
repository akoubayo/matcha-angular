import {GeolocationComponent, EmitterService}   from '../geolocation.component';
import {Injectable} from '@angular/core';
import { Http, Headers, BaseRequestOptions, RequestOptions, Response,XSRFStrategy, CookieXSRFStrategy } from '@angular/http';
import { CORE_DIRECTIVES, FORM_DIRECTIVES } from '@angular/common';
import {Location} from './../location-interface';
import {NoXSRFStrategy} from '../geolocation.module'
/**
...
export class nglocationService {
  ...
  /**
    ...
    displayLocation = (latitude,longitude) => {
      this.http.get('http://maps.googleapis.com/maps/api/geocode/json?latlng='+latitude+','+longitude+'&sensor=true',this.headers)
